...
public final class HudEditor extends Module {
    ...
    public static final Setting<Float> hudRound = new Setting<>("HudRound", 2.5f, 1f, 7f);
    public static final Setting<Float> alpha = new Setting<>("Alpha", 0.85f, 0f, 1f);
    ...
    public static final Setting<Float> blurStrength = new Setting<>("BlurStrength", 5f, 1f, 50f);
