...
public final class SoundFX extends Module {
    ...
    public final Setting<OnOffSound> enableMode = new Setting<>("EnableMode", OnOffSound.Default);
    public final Setting<OnOffSound> disableMode = new Setting<>("DisableMode", OnOffSound.Default);
