...
public class Strafe extends Module {
    ...
    public void onPacketReceive(PacketEvent.Receive e) {
        ...
        if (e.getPacket() instanceof EntityVelocityUpdateS2CPacket && (velocity = (EntityVelocityUpdateS2CPacket) e.getPacket()).getEntityId() == mc.player.getId() && boost.getValue() == Boost.Damage) {
